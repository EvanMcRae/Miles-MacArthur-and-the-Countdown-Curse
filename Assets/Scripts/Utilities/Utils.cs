...
//     private static extern bool OnMacWeb();
// #endif
    public static bool OnMac()
    {
        bool result = Application.platform == RuntimePlatform.OSXEditor || Application.platform == RuntimePlatform.OSXPlayer;
// #if !UNITY_EDITOR && UNITY_WEBGL
//         result = result || OnMacWeb();
// #endif
        return result;
    }
}